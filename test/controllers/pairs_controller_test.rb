...
class PairsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pair" do
    assert_difference('Pair.count') do
      post pairs_url, params: { pair: { away: @pair.away, home: @pair.home, round_id: @pair.round_id } }
    end
  ...
  test "should update pair" do
    patch pair_url(@pair), params: { pair: { away: @pair.away, home: @pair.home, round_id: @pair.round_id } }
